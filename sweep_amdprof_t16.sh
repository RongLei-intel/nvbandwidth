...
md_lines = [
    ...
    '',
    '| SM copy bytes | Buffer MiB | LoopCount | Status | nvbandwidth SUM | System Mem Rd median | System Mem Rd p95 | System PCIe Rd median | System PCIe Rd p95 | Samples | Result dir |',
    '| ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |',
]
for row in rows:
    md_lines.append(
